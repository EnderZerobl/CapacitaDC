...
import { contentData, eixoLabels, type Eixo } from "@/lib/content-data"
...
export default function TraineesPage() {
  ...
  // Filter contents - trainees can only see trainee content
  const traineeContents = useMemo(() => {
    return contentData
      .filter((content) => content.type === "trainee")
      .filter((content) => {
        ...
        <div className="bg-card border border-border rounded-lg p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Aqui você encontra todos os conteúdos de capacitação para seu
                desenvolvimento no setor comercial. Explore os materiais por
                eixo e acompanhe seu progresso.
              </p>
            </div>
          </div>
        </div>
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-2">
            ...
            <Badge variant="secondary" className="bg-secondary text-secondary-foreground">
              {traineeContents.length} disponíveis
            </Badge>
          </div>
